...
$$S_t = S_0 \, e^{\big(\mu - \frac{\sigma^2}{2}\big)  t + \sigma W_t}, \label{gbm}$$
where
\begin{itemize}
...
with initial value $S_0=50$, drift $\mu=0.1$, and volatility $\sigma=\sqrt{0.2}$ over a 5‐year horizon using IID sampling:
...
DOI: 10.5281/zenodo.1440997. Retrieved from \url{https://www.quantlib.org}.
