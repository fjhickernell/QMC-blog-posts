...
GBM is commonly used to model stock prices driving option payoffs in derivatives pricing \cite{hull2017, ross2014}. 

\subsection{GBM Objects in QMCPy}

GBM in QMCPy inherits from BrownianMotion class \cite{HeiKelNie08a,QMCPy2020a} 
...
In this section, we compare QMCPy's GeometricBrownianMotion implementation with the industry-standard QuantLib library \cite{quantlib} to validate its accuracy and performance. %We use Listing~\ref{lst:quantlib} to generate the QuantLib paths.
