\begin{table}[tbp]
\caption{GBM Final Value Statistics and Performance Comparison. \SCComment{Update table}}
\label{tab2}
...
\toprule
Method & Sampler & Mean & Std Dev & Mean Absolute & Std Dev & Mean Time (s)  & Std Dev & Speedup \\
 &  &  &   &  Error &  Error &   &  Time &  \\
\midrule
