...
\newcommand{\scnote}[1]{{\color{teal}{\bf Sou-Cheng}: #1}}

\newcommand{\LarysaNote}[1]{{\color{DarkOrchid}{\bf Larysa}: #1}}
...
\blogpost{Parsl Accelerated QMCPy Notebook Tests}{\author{Joshua Jay Herman (QMCPy Development Team),  Brandon Sharp (JPMorgan Chase \& Co.), and Sou-Cheng Choi (Illinois Tech and SouLab LLC)}}{parslTestbookQMCblog}{booktests/parslTestbookQMCblog}
\end{document}
