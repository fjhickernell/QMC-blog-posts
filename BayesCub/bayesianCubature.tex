...
\code{CubBayesLatticeG} and \code{CubBayesNetG} are the two stopping criterion algorithms that uses Bayesian approach.  These algorithms are guaranteed for integrands belonging to cone of functions which reside in the middle of the sample space defined by Gaussian process parameters. 
